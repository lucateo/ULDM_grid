...
int main(int argc, char** argv){
  ...
  if (initial_cond == "NFW" ) {// External NFW initial conditions
  ...
  else if (initial_cond == "NFW_Hernquist_ext_Eddington" ) {// External NFW initial conditions with Eddington NFW profile
    if (params_initial_cond.size() > 6){
      ...
      outputname = directory_name+"out_Ext_Eddington_Hernquist_NFW" + outputname
        + "_RsExt_" + to_string(rs_nfw) + "_rh0Ext_" + to_string(rho0_tilde)
